...
### コミュニケーションの原則
- **質問を積極的に**: 不明点や情報がどこにあるかわからない時は必ず質問すること
- **より良い提案を**: 指示された内容よりもよりよいやり方があるときは必ず提案すること
- **チーム全体で意見交換**: 重要な決定は独断せず、チーム全体で意見交換しながらよりよいゴールを目指して進めること

### 開発の進め方
- **MVP優先**: 完璧を求めすぎず、まず動くものを作る
- **段階的改善**: 最小限の機能から始めて、徐々に改善していく
- **テストの徹底**: 実装したら必ずテストを行う
- **進捗の共有**: 定期的に進捗を共有し、ブロッカーがあれば即座に報告

### ドキュメント管理
- **作業ログ**: 重要な作業は`/docs/worklog/`に記録
- **コミュニケーションファイル**: 
  - `temp.md` - 一時的なメモ
  - `to_all.md` - チーム全体への連絡
  - `to_[名前].md` - 個別メンバーへの連絡
  - `report_[名前].md` - 各メンバーからの報告
