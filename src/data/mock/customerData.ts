...
export const topCustomers: TopCustomer[] = [
  { id: "C001", name: "パティスリー・ラ・シュエット", totalSpent: 450000, orders: 12, lastOrder: "2024-03-15", segment: "VIP" },
  { id: "C002", name: "菓子工房マリエット", totalSpent: 380000, orders: 9, lastOrder: "2024-03-18", segment: "VIP" },
  { id: "C003", name: "カフェ・ミラージュ", totalSpent: 320000, orders: 8, lastOrder: "2024-03-20", segment: "リピーター" },
  { id: "C004", name: "洋菓子店エトワール", totalSpent: 280000, orders: 7, lastOrder: "2024-03-12", segment: "リピーター" },
  { id: "C005", name: "手作りお菓子工房クローバー", totalSpent: 250000, orders: 6, lastOrder: "2024-03-22", segment: "リピーター" },
];
...
export const customerDetailData: CustomerDetail[] = [
  ...
  },
  {
    ...
    status: "VIP",
    lastOrderDate: new Date("2024-05-15"),
    topProducts: getTopProductsByCategory(["パウンドケーキ箱", "ギフト・包装材", "紙袋"]),
    productCategories: ["パウンドケーキ箱", "ギフト・包装材"],
    repeatProducts: 2,
  },
  // 追加の顧客データ
  {
    ...
    topProduct: getRandomProductName(),
    status: "VIP",
    lastOrderDate: new Date("2024-05-25"),
    topProducts: getTopProductsByCategory(["デコ箱・ケーキ系", "ギフト・包装材", "プラトレー・紙トレー"]),
    productCategories: ["デコ箱・ケーキ系", "ギフト・包装材", "プラトレー・紙トレー"],
    repeatProducts: 3,
  },
  {
    id: "12358",
    ...
    topProduct: getRandomProductName(),
    status: "リピーター",
    lastOrderDate: new Date("2024-05-12"),
    topProducts: getTopProductsByCategory(["パウンドケーキ箱", "紙袋"]),
    productCategories: ["パウンドケーキ箱", "紙袋"],
    repeatProducts: 1,
  },
  {
    id: "12359",
  ...
  },
  {
    ...
    status: "VIP",
    lastOrderDate: new Date("2024-05-20"),
    topProducts: getTopProductsByCategory(["デコ箱・ケーキ系", "配送・保冷材"]),
    productCategories: ["デコ箱・ケーキ系", "配送・保冷材"],
    repeatProducts: 2,
  },
  {
    id: "12361",
  ...
  },
  {
    ...
    status: "VIP",
    lastOrderDate: new Date("2024-05-18"),
    topProducts: getTopProductsByCategory(["デコ箱・ケーキ系", "ギフト・包装材", "配送・保冷材"]),
    productCategories: ["デコ箱・ケーキ系", "ギフト・包装材", "配送・保冷材"],
    repeatProducts: 3,
  },
  {
    id: "12364",
    ...
    topProduct: getRandomProductName(),
    status: "リピーター",
    lastOrderDate: new Date("2024-05-14"),
    topProducts: getTopProductsByCategory(["プラトレー・紙トレー", "パウンドケーキ箱"]),
    productCategories: ["プラトレー・紙トレー", "パウンドケーキ箱"],
    repeatProducts: 2,
  },
  {
    id: "12365",
    ...
    topProduct: getRandomProductName(),
    status: "リピーター",
    lastOrderDate: new Date("2024-04-22"),
    topProducts: getTopProductsByCategory(["デコ箱・ケーキ系", "紙袋"]),
    productCategories: ["デコ箱・ケーキ系", "紙袋"],
    repeatProducts: 1,
  },
  {
    id: "12366",
