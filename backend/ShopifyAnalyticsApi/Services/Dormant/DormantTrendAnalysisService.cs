            ...
            try
            {
                ...
                var newDormant = await _context.Customers
                    ...
                    .Where(c => c.Orders.Any() && 
                              c.Orders.OrderByDescending(o => o.CreatedAt).First().CreatedAt >= cutoffStart &&
                              c.Orders.OrderByDescending(o => o.CreatedAt).First().CreatedAt < cutoffEnd)
                    .CountAsync();
            ...
            try
            {
                ...
                var reactivated = await _context.Orders
                    ...
                    .Where(o => _context.Orders
                        ...
                        .First().CreatedAt < dormancyCutoff)
