...
namespace ShopifyTestApi.Migrations
{
    ...
    [Migration("20250721102240_AddMultiStoreSupportWithNoAction")]
    partial class AddMultiStoreSupportWithNoAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopifyTestApi.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5222),
                            ...
                            TotalOrders = 3,
                            TotalSpent = 25000m,
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5237)
                        },
                        new
                        {
                            Id = 2,
                            AcceptsEmailMarketing = false,
                            AcceptsSMSMarketing = false,
                            CreatedAt = new DateTime(2025, 7, 14, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5243),
                            ...
                            TotalOrders = 1,
                            TotalSpent = 8500m,
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5244)
                        },
                        new
                        {
                            Id = 3,
                            AcceptsEmailMarketing = false,
                            AcceptsSMSMarketing = false,
                            CreatedAt = new DateTime(2025, 1, 22, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5246),
                            ...
                            TotalOrders = 15,
                            TotalSpent = 125000m,
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5247)
                        });
                });
            ...
            modelBuilder.Entity("ShopifyTestApi.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 7, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5650),
                            Currency = "JPY",
                            CustomerId = 1,
                            OrderNumber = "ORD-001",
                            Status = "completed",
                            ...
                            TaxPrice = 700m,
                            TotalPrice = 7000m,
                            UpdatedAt = new DateTime(2025, 7, 7, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5650)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 7, 14, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5653),
                            Currency = "JPY",
                            CustomerId = 2,
                            OrderNumber = "ORD-002",
                            Status = "completed",
                            ...
                            TaxPrice = 800m,
                            TotalPrice = 8500m,
                            UpdatedAt = new DateTime(2025, 7, 14, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5653)
                        });
                });
            ...
            modelBuilder.Entity("ShopifyTestApi.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "衣類",
                            CreatedAt = new DateTime(2025, 5, 22, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5619),
                            Currency = "JPY",
                            ...
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5620)
                        },
                        new
                        {
                            Id = 2,
                            Category = "雑貨",
                            CreatedAt = new DateTime(2025, 6, 6, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5622),
                            Currency = "JPY",
                            ...
                            StoreId = 0,
                            Title = "ステンレス製タンブラー",
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5622)
                        },
                        new
                        {
                            Id = 3,
                            Category = "食品",
                            CreatedAt = new DateTime(2025, 6, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5624),
                            Currency = "JPY",
                            ...
                            StoreId = 0,
                            Title = "オーガニック緑茶セット",
                            UpdatedAt = new DateTime(2025, 7, 21, 10, 22, 39, 697, DateTimeKind.Utc).AddTicks(5624)
                        });
                });
