...
- **本番URL**: `https://brave-sea-038f17a00.azurestaticapps.net`
- **代替URL**: `https://brave-sea-038f17a01.azurestaticapps.net`
...
### **API接続テストページ**
- **本番**: `https://brave-sea-038f17a00.azurestaticapps.net/api-test`
...
2. **API テスト**: `https://brave-sea-038f17a00.azurestaticapps.net/api-test`
3. **本番確認**: 各本番URLでの動作確認
...
### **更新履歴**
- **2025-07-21**: 初版作成 - フロントエンド・バックエンド統合完了
