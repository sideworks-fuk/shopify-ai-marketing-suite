...
| No | 画面ID | カテゴリ | 画面名 | 画面設計 | リリース優先度 | 主要機能 |
|---|---|---|---|---|---|---|
| 1 | **PROD-01-YOY** | 商品分析 | **前年同月比【商品】** | ✅ 完了 | 🔴 **Tier 1** | 商品別売上の前年比較・トレンド分析 |
| 6 | **PURCH-03-FTIER** | 購買分析 | **F階層傾向【購買】** | ✅ 完了 | 🔴 **Tier 1** | 購入頻度による顧客階層分析 |
| 8 | **CUST-01-DORMANT** | 顧客分析 | **休眠顧客【顧客】** | ✅ 完了 | 🔴 **Tier 1** | 休眠顧客分類・復帰施策管理 |
| 3 | **PROD-03-BASKET** | 商品分析 | **組み合わせ商品【商品】** | ✅ 完了 | 🔴 **Tier 2** | マーケットバスケット分析 |

### 📋 **Phase 2以降リリース予定画面（4機能）**

| No | 画面ID | カテゴリ | 画面名 | 画面設計 | リリース予定 | 主要機能 |
|---|---|---|---|---|---|---|
| 2 | **PROD-02-FREQ** | 商品分析 | 購入頻度【商品】 | ✅ 完了 | Phase 2 (2025年Q4) | 商品別リピート購入パターン分析 |
| 4 | **PURCH-01-MONTHLY** | 購買分析 | 月別売上統計【購買】 | ✅ 完了 | Phase 2 (2025年Q4) | 商品×月別売上推移分析 |
| 5 | **PURCH-02-COUNT** | 購買分析 | 購入回数【購買】 | ✅ 完了 | Phase 3 (2026年Q1) | 顧客の購入回数別セグメント分析 |
| 7 | **CUST-02-ANALYSIS** | 顧客分析 | 顧客購買【顧客】 | ✅ 完了 | Phase 3 (2026年Q1) | 顧客別詳細購買プロファイル |
...
├── 🏠 ダッシュボード（未実装）
├── 📊 売上分析
│   ├── 前年同月比【商品】 (PROD-01-YOY)
│   ├── 購入頻度【商品】 (PROD-02-FREQ)
│   ├── 組み合わせ商品【商品】 (PROD-03-BASKET)
│   └── 月別売上統計【購買】 (PURCH-01-MONTHLY)
├── 👥 顧客分析
│   ├── 購入回数【購買】 (PURCH-02-COUNT)
│   ├── F階層傾向【購買】 (PURCH-03-FTIER)
│   ├── 顧客購買【顧客】 (CUST-02-ANALYSIS)
│   └── 休眠顧客【顧客】 (CUST-01-DORMANT)
└── 🤖 AIインサイト（未実装）
```
