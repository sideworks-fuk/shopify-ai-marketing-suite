...
flowchart TD
    ...
    WaitButton --> UserClick["ユーザーが接続を開始<br/>ボタンをクリック"]
...
- 2025-12-29: Mermaid構文エラーを修正
  - 日本語の特殊文字（「」）を削除
  - ノード内のテキストを引用符で囲むように修正
  - エッジラベルの特殊文字を引用符で囲むように修正
- 2025-12-29: ドキュメント改善
  - ドキュメント情報テーブルを追加
  - 調査結果記録テンプレートを統一（テーブル形式を追加）
  - 環境設定確認項目を追加
  - 関連ドキュメントセクションを強化